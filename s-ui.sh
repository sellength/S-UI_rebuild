...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/sellength/S-UI_rebuild/main/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/sellength/S-UI_rebuild/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
